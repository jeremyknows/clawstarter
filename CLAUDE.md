...
# Minimal mode (gateway only, 16 steps)
...
├── openclaw-autosetup.sh             # 18-step automated setup
├── openclaw-verify.sh                # 17-check diagnostic
...
- **Account-switching flow:** All admin/sudo tasks consolidated in Step 1. User switches to bot user ONCE and stays there.
...
- Autosetup minimal mode: STEP_TOTAL=16 (skips mac_user + discord)
